...
Shown in the footer "Funded & hosted by" strip on every page. Each logo sits on a
white chip and falls back to a text wordmark if its file is missing.
...
For official brand files, see each institution's brand page (e.g. univ-lyon1.fr brand kit,
erc.europa.eu/support/logos).
